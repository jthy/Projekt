			...
			while(!input1.equals("Logout"))
			{
			 if(input1.equals("Fisch")){
				 System.out.println("Optionen:");
					...
					System.out.println("	Node l�schen");
				 ...
				 else if(input2.equals("Node l�schen")) {
					 publisher.loescheFischNode();
					 System.out.println("\"Fisch\"-Node wurde gel�scht");
				 }
				 else if(input2.equals("Publish ohne Payload")) {
					 publisher.veroeffentlicheFisch();
					 System.out.println("\"Fisch\"-Node enth�lt eine neue Nachricht.");
				 }
				 else if(input2.equals("Publish mit Payload")){
					 publisher.veroeffentlicheFischmitPayload();
					 System.out.println("\"Fisch\"-Node enth�lt eine neue Nachricht mit Payload.");
				 }
				 ...
				 else if(input3.equals("Node l�schen")) {
					 publisher.loescheFleischNode();
					 System.out.println("\"Fleisch\"-Node wurde gel�scht");
				 }
				 else if(input3.equals("Publish ohne Payload")) {
					 publisher.veroeffentlicheFleisch();
					 System.out.println("\"Fleisch\"-Node enth�lt eine neue Nachricht.");
				 }
				 ...
				 else if(input4.equals("Node l�schen")) {
					 publisher.loescheGemueseNode();
					 System.out.println("\"Gemuese\"-Node wurde gel�scht");
				 }
				 else if(input4.equals("Publish ohne Payload")) {
					 publisher.veroeffentlicheGemuese();
					 System.out.println("\"Gemuese\"-Node enth�lt eine neue Nachricht.");
				 }
				 else if(input4.equals("Publish mit Payload")){
					 publisher.veroeffentlicheGemuesemitPayload();
					 System.out.println("\"Gemuese\"-Node enth�lt eine neue Nachricht mit Payload.");
				 }
